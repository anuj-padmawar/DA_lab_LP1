...
# In the terminal execute following commands one by one:
...
# -------------------- HOW TO RUN PROGRAM ------------------------- 
# Exceute the following command in terminal:
# python3 twitter_sentiment_analysis.py

# -------------------- SEE THE OUTPUT ---------------------------
# output.csv will be generated if the program executes succesfully
# Also you can read the hatet tweet count and non-hate tweet counts on terminal
